...
- Lifts where your body isn't the resistance — curls, flies, extensions — can't be scored that way, because pounds don't mean the same thing across movements (10 lbs on a fly is brutal; 10 lbs on a leg press is nothing). Those are scored against a **working load** you set in ⚙ Manage Exercises (`hard @`): the weight at which a set of 10 is a genuine fight. Log it in the same units you log your sets — per dumbbell or total, it only has to match itself.
